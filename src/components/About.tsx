...
export default function About({ params }: { params?: {} }) {
  return (
    <section className="h-[dvh-3rem] sm:h-[initial]">
      <div className="flex items-center justify-center flex-col">
        ...
        >
          ...
          <div className="mt-6 flex flex-col items-center justify-center text-left sm:text-center text-gray-700 text-xl max-w-lg sm:text-2xl pl-10 pr-10 sm:pl-0 sm:pr-0">
            ...
            <div className="flex flex-col pl-3 pr-3 break-keep">
              <p className="mt-4">
                <span className="font-bold">2년 </span>동안{" "}
                <span className="font-bold">웹, 앱, 서버</span>를 개발하며
                효율적인 코드 작성과 재사용성에 대해 고민했습니다.
              </p>
              <p className="mt-1">
                주도적으로 문제를 파악하고 집요하게 파고들어 해결하는 걸
                즐깁니다.
              </p>
            </div>
          </div>
