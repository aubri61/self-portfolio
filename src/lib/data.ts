...
export const projectsData: IProject[] = [
  {
    title: "Angular + Electron 기반 데스크톱 포모도로 타이머",
    description:
      "Angular와 Electron을 활용해 제작한 macOS 데스크톱 타이머 앱입니다. signal/computed 기반 상태관리, preload-IPC 구조, Tray/Notification 연동 등을 직접 구현하며 Angular와 Electron의 기본 구동 원리를 익히는 데 초점을 맞췄습니다.",
    did: [
      "signal / computed 기반으로 타이머 상태, 모드, 설정값, 파생 UI 값 관리",
      "포모도로 타이머 로직 구현: work / short break / long break 전환, pause / reset 흐름 처리",
      "Electron main / preload / renderer 구조 분리 및 IPC 통신 연동",
      "상태에 따라 UI를 분기하는 템플릿 구조 설계",
      "BrowserWindow, Tray, Menu, Notification을 활용한 macOS 데스크톱 앱 기본 UX 구현",
      "preload에서 contextBridge로 안전한 브리지 API 노출 및 renderer 접근 제한",
      "localStorage를 이용한 알림음 설정값 저장 및 앱 재실행 시 복원",
      "Always-on-top 오버레이 모드와 윈도우 투명도 조절, 시스템 사운드 재생 기능 실험",
    ],
    stacks: [
      "Angular",
      "TypeScript",
    ...
    materials: true,
    materialType: "image",
    materialSrc: "/timer.gif",
      sourceCodeUrl: "https://github.com/aubri61/realtime-timer",
  },
  // {
